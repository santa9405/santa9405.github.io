---
title: "WebServer"
excerpt: "WebServer Project - Login, Logout"
search: true
categories: 
  - Academy
tags: 
...
## 기능 화면
- 로그인<br>
![20201228_171511_admin로그인](https://user-images.githubusercontent.com/72387870/103200407-a034ba00-4930-11eb-8437-0c81cfa202a8.png)<br>
![20201228_171535_김관리](https://user-images.githubusercontent.com/72387870/103200446-b478b700-4930-11eb-9ed1-725f242a527d.png)<br><br>

- 로그아웃<br>
![image](https://user-images.githubusercontent.com/72387870/103200484-cd816800-4930-11eb-85cc-443460a27ced.png)<br><br>

## 프로젝트 구성<br>
![image](https://user-images.githubusercontent.com/72387870/103150218-4bb8ff80-47b5-11eb-91d0-ba975bae0581.png)
<br><br>
...
```sql
-- 관리자 계정으로 접속하여 실행 f5을 눌러 실행
DROP USER server cascade;

CREATE USER server IDENTIFIED BY server;

GRANT CONNECT, RESOURCE, CREATE VIEW TO server;
...
-- 샘플 데이터
INSERT INTO MEMBER 
VALUES (SEQ_MNO.NEXTVAL, 'admin', '1234', '김관리', '010-1111-2222', 'admin@kh.or.kr', '04540, 서울특별시 중구 남대문로 120, 2층 KH정보교육원 종로지원 A강의장', NULL, SYSDATE, DEFAULT, DEFAULT);

INSERT INTO MEMBER 
VALUES (SEQ_MNO.NEXTVAL, 'user01', 'pass01', '홍길동', '010-3333-4444', 'user01@kh.or.kr', '06234, 서울특별시 강남구 테헤란로14길 6, 3층 KH정보교육원 강남지원', NULL, SYSDATE, DEFAULT, DEFAULT);

COMMIT;
```
- column<br>
![image](https://user-images.githubusercontent.com/72387870/103150595-05fe3600-47b9-11eb-9e73-ef4f727fb7d9.png)<br><br>
- sampleData<br>
![image](https://user-images.githubusercontent.com/72387870/103150618-46f64a80-47b9-11eb-8434-b02dcbb95520.png)<br><br>
...
## WebContent/WEB-INF/views/common
...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// 6_1. 로그인이 성공했을 때만 Session에 로그인 정보 추가하기
			if(loginMember != null) {
